...
return [
    ...
    */
    ...
    'providers' => [
        ...
        'publicidades' => [
            'driver' => 'eloquent',
            'model' => App\Models\Publicidad::class,
        ],
        ...
        'dependencias' => [
            'driver' => 'eloquent',
            'model' => App\Models\Dependencia::class,
        ],
        ...
        'dosificadores' => [
            'driver' => 'eloquent',
            'model' => App\Models\Dosificador::class,
        ]
