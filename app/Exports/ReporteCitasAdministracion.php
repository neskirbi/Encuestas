...
class ReporteCitasAdministracion implements FromView{
    ...
    public function  __construct($obra,$ini,$fin,$id_planta){
        ...
        ->select('citas.obra','citas.id','citas.folio','citas.fechacita','citas.regsct',
        'citas.razonsocial','citas.calleynumerofis','citas.coloniafis','citas.municipiofis',
        'citas.cpfis','citas.calleynumeroobr','citas.coloniaobr','citas.municipioobr',
        'citas.cpobr','citas.unidades','citas.cantidad','citas.precio','citas.precio',
        'citas.cantidad','citas.iva','citas.vehiculo','citas.marcaymodelo','citas.matricula',
        'citas.ramir','citas.condicionesmaterial','citas.condicionesmaterial',
        'citas.nombrecompleto','citas.recibio','citas.cargo',DB::raw("(select concat(categoriamaterial,': ',material) as observacion from materialesobra where id=citas.id_materialobra) as observacion"))
        ->orderby('folio','asc')
        ->get();
