...
class PedidoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('GeneralAdministracion.pedidos.pedidos',['pedidos'=>$pedidos]);
    }
    ...
    public function show($id)
    {
        ...
        return view('GeneralAdministracion.pedidos.pedido',['obra'=>$obra,'pedido'=>$pedido,'productos'=>$productos,'transportes'=>$transportes,'vehiculos'=>$vehiculos]);
    }
    ...
    function BuscarCodigo(Request $request){
        $remision=Remision::where('referencia',$request->codigo)->first();
        ...
        $detalle=DetallePedido::find($remision->id_detallepedido);


        
       
        return redirect('pedidosd/'.$detalle->id_pedido)->with('success','Pedido encontrado');
    }
    ...
    function RemisionWeb($id){
        $remision=Remision::find($id);
        return view('GeneralAdministracion.pedidos.remision',['remision'=>$remision]);
    }
