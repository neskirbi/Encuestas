...
class PedidoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dosificadores.pedidos.pedidos',['pedidos'=>$pedidos]);
    }
    ...
    public function show($id)
    {
        ...
        return view('dosificadores.pedidos.pedido',['obra'=>$obra,'pedido'=>$pedido,'productos'=>$productos,'transportes'=>$transportes,'vehiculos'=>$vehiculos]);
    }
    ...
    function RemisionWeb($id){
        $remision=Remision::find($id);
        return view('dosificadores.pedidos.remision',['remision'=>$remision]);
    }
