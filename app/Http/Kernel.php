...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'uiaslogged' => \App\Http\Middleware\UiasIsLogged::class, 
        'finanzaslogged' => \App\Http\Middleware\FinanzasIsLogged::class, 
        ...
        'publicidadeslogged' => \App\Http\Middleware\PublicidadIsLogged::class,
    ];
}
