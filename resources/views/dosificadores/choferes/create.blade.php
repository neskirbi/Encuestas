...
<head>
  ...
  <title>{{GetSiglas(0)}} | Chofer</title>
        ...
        <div class="col-md-12">
          <div class="card card-default">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  <form action="{{url('choferesd')}}" method="POST">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="row">                          
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required type="text" onkeyup="ValidarPass();" name="pass" class="form-control" id="pass" placeholder="Contraseña" aria-invalid="false" maxlength="255" >
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                                <label for="pass">Confirmar Contraseña</label>
                                <input required type="text" onkeyup="ValidarPass();" name="pass2" class="form-control" id="pass2" placeholder="Contraseña" aria-invalid="false" maxlength="255" >
                            </div>
                          </div>
                        </div>
                    </div>
