        ...
        <div class="row" >
          <div class="col-md-12">
            <div class="card card-default">
              ...
              <div class="card-body">
                <div class="p-2">
                  <a href="choferesd/create" class="btn btn-primary"><span><i class="fa fa-plus" aria-hidden="true"></i></span> Chofer</a>
                </div>
                <div class="row">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <div class="row" > 
                          ...
                          <div class="col-md-6">
                            <a href="choferesd/{{$chofer->id}}" class="float-right" ><i class="link" aria-hidden="true"></i> Editar</a>
                          </div>  
