        ...
        <div class="row" >
          <div class="col-md-12">
            <div class="card card-default">
                ...
                <div class="card-tools">
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" style="width:300px;">
                      <form class="px-4 py-3" action="{{url('vehiculosd')}}" method="GET">
                        ...
                        <a href="vehiculosd" class="btn btn-default btn-sm">Limpiar</a>
              ...
              <div class="card-body">
                <div class="p-2">
                  <a href="vehiculosd/create" class="btn btn-primary"><span><i class="fa fa-plus" aria-hidden="true"></i></span> Vehículo</a>
                </div>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <div class="row" > 
                          ...
                          <div class="col-md-6">
                            <a href="vehiculosd/{{$vehiculo->id}}" target="_blank" class="float-right" ><i class="link" aria-hidden="true"></i> Editar</a>
                          </div>  
