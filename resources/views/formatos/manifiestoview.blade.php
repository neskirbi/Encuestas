...
<center>
    ...
    <div class="alert alert-info" role="alert">
        El residuo se encuentra en {{$cita->obra}}
    </div>
    @elseif($cita->confirmacion==1)
    <div class="alert alert-success" role="alert">
        El residuo ya fue entregado a {{$cita->planta}}
    </div>
    ...
    <div class="alert alert-warning" role="alert">
        El residuo se dirige a {{$cita->planta}}
    </div>
    @endif

    <table style="border-collapse: collapse; width:100%;">
        <tr>
            <td class="bordes"><center><img style="width:15px; padding:10px;" src="{{asset('images/formatos/manifiesto/generador.png')}}" alt="Generador"></center></td>
            <td class="bordes">
                <p><b>Folio: {{$cita->folio}}</b></p>
                1.-NÚM. DE REGISTRO (Resolutivo de Impacto Ambiental, Plan de Manejo): <b>{{$cita->nautorizacion}}</b>
                <img style=" float:right;" src="{{asset('images/qr/manifiesto/'.$cita->qr)}}" width="90px" alt="">
        ...
        <tr>
            <td class="bordes"><center><img style="width:15px; padding:10px;" src="{{asset('images/formatos/manifiesto/transporte.png')}}" alt="Transporte"></center></td>
            <td class="bordes">
                ...
                <hr>
                9.- DISTANCIA RECORRIDA DESDE LA EMPRESA GENERADORA HASTA SU ENTREGA (Km). {{$cita->distancia}} Km
                <br>
                <hr>
                <table style="border-collapse: collapse;" class="probable100">
                    <tr>
        ...
        <tr>
            <td class="bordes"><center><img style="width:15px; padding:20px;" src="{{asset('images/formatos/manifiesto/destino.png')}}" alt="Destino"></center></td>
            <td class="bordes">
                <table border="1" style="border-collapse: collapse;" class="probable100">
                    <tr>
