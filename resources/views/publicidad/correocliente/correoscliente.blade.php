          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="card-title">Correo Alta Cliente</div>
              </div>
              <div class="card-body">

              <form action="{{url('ProbarCorreoCliente')}}" enctype="multipart/form-data" method="post">
                @csrf
                ...
                <form action="{{url('CargarClienteCorreo')}}" enctype="multipart/form-data" method="post">
                @csrf
                ...
                <div class="row">
                  <div class="col-md-12">
                    <p>Poner esta etiqueta <b>@cliente</b> donde se cargara el nombre del cliente y <b>@mail</b> donde se cargara el correo del cliente.</p>
