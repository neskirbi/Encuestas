        ...
        <div class="col-md-12">
          <div class="card card-default">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                <form method="POST" action="{{url('vehiculo').'/'.$vehiculo->id}}" id="formobra" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input required type="text" name="matricula" class="form-control" id="matricula" placeholder="Matrícula" aria-invalid="false" maxlength="100" value="{{$vehiculo->matricula}}" >
                                </div>
