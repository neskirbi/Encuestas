                ...
                <div class="card-tools">
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" style="width:300px;">
                      <form class="px-4 py-3" action="{{url('vehiculo')}}" method="GET">
                        ...
                        <a href="vehiculo" class="btn btn-default btn-sm">Limpiar</a>
                    ...
                    <div class="card">
                      ...
                      <font style="font-size:15px; "><b>{{$vehiculo->razonsocial}}</b></font><br>
                        ...
                        <div class="row" > 
                          ...
                          <div class="col-md-6">
                            <a href="vehiculo/{{$vehiculo->id}}" target="_blank" class="float-right" ><i class="link" aria-hidden="true"></i> Editar</a>
                          </div>  
