...
<body>
    <div class="row">
        ...
        <div class="col-12">
            ...
            <tbody>
                ...
                <td><a target="_blank" href="{{url('transferencias/'.$recepcion->id)}}" class="btn btn-info"><i class="fa fa-eye"></i> Revisar</a></td>
    ...
    {{ $envios->appends($_GET)->links('pagination::bootstrap-4') }}
