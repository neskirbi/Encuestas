...
<form action="{{url('CitasSedemaPlanta')}}" id="GraficasCitasDirector">
    <div class="row">                              
        <div class="col-md-6">
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-2">
            <div class="input-group mb-3">
                <input name="year" id="year" class="form-control" type="number" step="1" min="2021" value="{{isset($year) ? $year : date('Y')}}" onchange="Submite();">                                    
