                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                <input required data-invalido="true" type="text" name="pregunta[]" id="ubicacion"  class="form-control" aria-invalid="false" style="display:none;">
                                                </div>
                                ...
                                <script>
                                    function funcionInit(){
                                        ...
                                        const onUbicacionConcedida = ubicacion => {
                                            ...
                                            $('#ubicacion').val(ubicacion.coords.latitude+','+ubicacion.coords.longitude);
                                            $('#confirmar').show();
                                            $('#advertencia').hide();
