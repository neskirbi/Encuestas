                ...
                <div class="card-tools">
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" style="width:300px;">
                      <form class="px-4 py-3" action="{{url('citasadmin')}}" method="GET">
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text"><i class="far fa-user"></i></span>
                          </div>
                          <input type="text" class="form-control" name="razonsocial" id="razonsocial" placeholder="Generador" @if(isset($filtros->razonsocial)) value="{{$filtros->razonsocial}}" @endif >
                        </div>
                        ...
                        <a href="citasadmin" class="btn btn-default btn-sm">Limpiar</a>
                    ...
                    <table class="table table-hover text-nowrap">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <small class="badge badge-warning"><i class="fa fa-check" aria-hidden="true"></i>  En Tránsito</small>
                          @endif
                          </td>
                          <!--<td>
