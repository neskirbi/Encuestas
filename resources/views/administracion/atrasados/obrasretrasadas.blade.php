                  ...
                  <div class="col-md-12" style="overflow-x:scroll;">
                    ...
                    <table class="table table-hover text-nowrap" id="obras">
                      ...
                      <tbody>
                        ...
                        @if($obra->deshabilitada==0 && $obra->terminada==0)
                        <tr>
                        @elseif($obra->deshabilitada==1 && $obra->terminada==0)
                        <tr  class="table-danger">
                        @elseif($obra->terminada==1)
                        ...
                        @endif
                          ...
                          <td>
                            <a href="obra/{{$obra->id}}" target="_blank" class="btn btn-info btn-sm d-inline p-2" ><i class="fa fa-eye" aria-hidden="true"></i> Revisar</a>
                          </td>
