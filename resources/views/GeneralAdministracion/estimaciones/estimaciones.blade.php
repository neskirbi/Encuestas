                    ...
                    <table class="table table-hover text-nowrap" id="obras">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="text-align: left;">$ {{number_format(MasIva($obra->lana,$obra->ivaobra),2)}} </td> 
                          <td style="text-align: left;"> $ {{number_format(MasIva($obra->entregado*$factor,$obra->ivaobra),2)}} </td>
                          <td style="text-align: left;">$ {{number_format(MasIva(($obra->declarado - $obra->entregado)*$factor,$obra->ivaobra),2)}} </sup></td>                      
                          <td style="text-align: left;">{{number_format($obra->dias)}}</td>                                              
                          <td style="text-align: left;">{{number_format($obra->restante > $obra->dias ? $obra->dias : $obra->restante)}}</td>
                          @if(($obra->restante <= 0 ))
                          <td style="text-align: left;">$ {{number_format(MasIva(($obra->declarado - $obra->entregado)*$factor,$obra->ivaobra),2)}} </td>
                          @else
                          <td style="text-align: left;">$ {{number_format(MasIva(($obra->declarado - $obra->entregado)/$obra->restante*$factor,$obra->ivaobra),2)}} </td>
                          @endif
