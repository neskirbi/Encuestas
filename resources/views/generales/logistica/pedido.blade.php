                  ...
                  <table class="table table-hover text-nowrap">
                      ...
                      <tr>
                        ...
                        @if($remision->confirmacion==2)
                          @if($remision->planta_salida==$remision->planta_entrada)

                          @else
                          <!--<td><a target="_black"  href="{{url('Remision').'/'.$remision->id}}" class="btn btn-info float-right"><i class="fas fa-print"></i> Descargar</a></td>-->
                          @endif
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-9">
                      <div class="form-group">
                          <label for="costo">Comentarios</label>
...
@include('generales.pedidos.modals.remision')
</html>
