...
$remisiones = str_replace('“','',$remisiones);
$remisiones = str_replace('”','',$remisiones);
                ...
                .on('child_added',function(snapshot){
                    ...
                    for(var i in snapshot){
                        ...
                        if(typeof snapshot[i].val==='function'){
                            ...
                            /*console.log(snapshot[i].val().id);
                            console.log(snapshot[i].val().latitud);
                            console.log(snapshot[i].val().longitud);
                            console.log(snapshot[i].val().producto);*/
