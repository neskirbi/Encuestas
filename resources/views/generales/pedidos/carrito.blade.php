      ...
      <form action="pedidos" method="post" id='pedido'>
        ...
        <div class="row">
          <div class="col-12">
              ...
              <h5><i class="fa fa-tags"></i> Detalle Productos</h5>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-9">
                    <textarea data-invalido="false" class="form-control" rows="10" name="instruccionesp" placeholder="Comentarios"></textarea>
                  </div>
                  <div class="col-md-3">
                    <div class="row">
                      <div class="col-md-12">
        ...
        @if(count($logistica)>0)

        <div class="row">
          <div class="col-12">
              <div class="callout callout-warning">
              <h5><i class="fa fa-tags"></i> Detalle Logística</h5>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-9">
                    <textarea data-invalido="false" class="form-control" rows="10" name="instruccionest" placeholder="Comentarios"></textarea>
                  </div>
                  <div class="col-md-3">
                    <div class="row">
                      <div class="col-md-12">
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-footer">
                <a class="btn btn-info float-right" data-texto="¿Todos los datos son correctos?" onclick="Submite('pedido',this);"> <i class="fa fa-file-text" aria-hidden="true"></i> Generar Pedido</a>
