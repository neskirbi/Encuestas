                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6"> 
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="subtipoobra" id="subtipoobra" aria-invalid="false" disabled>
                                                <option value="">--Subtipo Obra--</option>
                                                @foreach($subtipoobras as $subtipoobra)
                                                <option value="{{$subtipoobra->id}}" name="options" data-categoria="{{$subtipoobra->tipoobra}}">{{$subtipoobra->subtipoobra}}</option>
                                                @endforeach
                                            </select>
                                        </div>                                   
