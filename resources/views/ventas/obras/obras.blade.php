                ...
                <div class="card-tools">
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" style="width:300px;">
                      <form class="px-4 py-3" action="{{url('obrav')}}" method="GET">
                        ...
                        <a href="{{url('obrav')}}" class="btn btn-default btn-sm">Limpiar</a>
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <td title="{{$obra->razonsocial}}">{{strlen($obra->razonsocial)<30 ? $obra->razonsocial : mb_substr($obra->razonsocial,0,29,"UTF-8").' ...'}}</td>
                      <td title="{{$obra->obra}}">{{strlen($obra->obra) > 30 ? mb_substr($obra->obra,0,29,"UTF-8").'...' : $obra->obra}}</td>
                      ...
                      <td>
                        <a href="obrav/{{$obra->id}}" class="btn btn-info btn-sm" ><i class="fa fa-eye" aria-hidden="true"></i> Ver</a>
                      </td>
