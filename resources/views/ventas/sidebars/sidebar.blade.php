        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
              ...
              <li class="nav-item">
                <a href="{{ url('citaspendientesventas') }}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ url('dashboardv') }}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ url('obrav') }}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ url('citasventas') }}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ url('pagosv') }}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ url('saldosv') }}" class="nav-link">
              <i class="nav-icon fa fa-dollar" aria-hidden="true"></i>
              <p>
                Saldos
              </p>
          ...
          <li class="nav-item">
            <a href="{{ url('reporteven') }}" class="nav-link">
