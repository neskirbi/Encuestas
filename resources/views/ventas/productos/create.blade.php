                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" class="form-control" name="producto" id="producto" placeholder="Producto">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input required type="number" min="0.0" step="0.01" class="form-control" name="precio" id="precio" placeholder="Precio">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required class="form-control" name="unidades" id="unidades" >
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" class="form-control" name="transporte" id="transporte">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea required class="form-control" rows="5" name="descripcion" id="descripcion" placeholder="Descripci&oacute;n"></textarea>
                                        </div>
                                    </div>
                                </div>                                
                            </div>
