                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      @if($remision->confirmacion==2)
                                        <a target="_black" href="{{url('Remision').'/'.$remision->id}}" class="btn btn-info float-right"><i class="fas fa-print"></i> Descargar</a>
                                      @endif
                                    </td>
                                  </tr>
                                  @endforeach
              ...
              <div class="card-footer">
                <div class="row">
                  <div class="col-md-3" style="padding:5px;">
                    <button style="width:100%;" class="btn btn-info" data-texto="¿Todos los datos son correctos?" onclick="Guardar('pedido',this,'{{url('GuardarPedido')}}/{{$pedido->id}}')"> <i class="fa fa-send" aria-hidden="true"></i> Comentar</button>
                  </div>
                  <div class="col-md-3" style="padding:5px;"></div>
                  <div class="col-md-3" style="padding:5px;">
                    @if($pedido->confirmacion!=0 && $nremisiones==0)
                    <button style="width:100%;" class="btn btn-danger" data-texto="El pedido será rechazado. ¿Desea continuar?" onclick="Rechazar('pedido',this,'{{url('RechazarPedido')}}/{{$pedido->id}}')"> <i class="fa fa-times"></i> Rechazar</button>
                    @endif
                  </div>
                  <div class="col-md-3" style="padding:5px;">
                    @if($pedido->confirmacion!=2)
                    @if(!TienePago($pedido->id))
                    <button style="width:100%;" class="btn btn-warning" data-texto="El pedido sera aceptado sin pago. ¿Desaa continuar?" onclick="Aceptar('pedido',this,'{{url('AceptarPedido')}}/{{$pedido->id}}')"> <i class="fa fa-check"></i> Aceptar sin pago</button>
                    @else
                    <button style="width:100%;" class="btn btn-success" data-texto="El pedido sera aceptado. ¿Desaa continuar?" onclick="Aceptar('pedido',this,'{{url('AceptarPedido')}}/{{$pedido->id}}')"> <i class="fa fa-check"></i> Aceptar</button>
                    @endif
                    @endif
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    @if(SaldoObra($obra->id)<0)
                    <span class="float-right" style="text-size:20px; color :#ff0000; font-weight: bold;">El saldo de esta obra es de : ${{SaldoObra($obra->id)}}</span>
                    @else
                    <span class="float-right" style="text-size:20px; color :#17A2B8; font-weight: bold;">El saldo de esta obra es de : ${{SaldoObra($obra->id)}}</span>
                    @endif
                  </div>
                </div>
...
@include('ventas.ventas.modals.remision')
...
<script>
  ...
  function CargarDatosRemision(_this){
    ...
    $('#orden').html((_this.data('orden')+1)+'/'+_this.data('orden'));
