          ...
          <div class="col-12">
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title"><i class="fa fa-calendar" aria-hidden="true"></i> Citas en Transito</h3>
                ...
                <div class="card-tools">
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" style="width:300px;">
                      <form class="px-4 py-3" action="{{url('citaspendientesventas')}}" method="GET">
                        ...
                        <a href="{{url('citaspendientesventas')}}" class="btn btn-default btn-sm">Limpiar</a>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-md-6">
                                        <form action="borrarcitaspendientesventas/{{$cita->id}}" method="POST"  class="d-inline p-2">
                                            {{ csrf_field() }}
                                            <button  id="borrar" class="borrar btn btn-danger" data-texto="¿Deseas quitar esta cita?"><i class="fa fa-times" aria-hidden="true"></i> Borrar</button>
