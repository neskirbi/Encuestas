                ...
                <div class="card-tools">
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" style="width:300px;">
                      <form class="px-4 py-3" action="{{url('saldosfi')}}" method="GET">
                        ...
                        <a href="saldosfi" class="btn btn-default btn-sm">Limpiar</a>
                  ...
                  <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        @endif
                        <td>
                        <a class=" btn btn-info" href="#" data-toggle="modal" data-target="#modalpago"  data-generador="{{$clientegasto->id}}" onclick="GetObrasPagosFin(this);">
                          Cargar Pago <i class="fa fa-money" aria-hidden="true"></i>
                        </a>
...
@include('finanzas.saldos.modals.modalpago')
</body>
</html>
