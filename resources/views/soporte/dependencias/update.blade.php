        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <form action="{{url('dependencias')}}/{{$dependecia->id}}" method="post">
                @csrf
                ...
                <div class="row">
                  <div class="col-md-7">
                      <div class="form-group">
                          ...
                          <input required type="text" name="nombre" class="form-control" id="nombre" placeholder="Nombre" aria-invalid="false" maxlength="150" value="{{$dependecia->nombre}}" >
                      </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input disabled type="text" name="mail" class="form-control" id="mail" placeholder="Correo" aria-invalid="false" maxlength="150"  value="{{$dependecia->mail}}">
                      </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required type="text" name="pass" class="form-control" id="pass" placeholder="Contrase&ntilde;a" aria-invalid="false" maxlength="150"  value="{{$dependecia->pass}}">
                      </div>
                  </div>
                </div>
