  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <form action="{{url('inspectores')}}" method="post">
              @csrf
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title"><i class="fa fa-group" aria-hidden="true"></i> Encuestadores</h3>
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      <div class="form-group">
                        <label for="inspector">Encuestador</label>
                        <input required type="text" class="form-control" id="inspector" name="inspector" placeholder="Encuestador">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
