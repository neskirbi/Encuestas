      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">                    
                    <div class="card-body">    
                        <form action="{{url('GuardarNombreEncuesta')}}/{{$id}}" method="post">
                        @csrf                    
                        
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="encuesta">Formulario</label>
                                    <input required data-invalido="true" type="text" name="encuesta" id="encuesta"  class="form-control" aria-invalid="false" value="{{isset($encuesta->encuesta) ? $encuesta->encuesta : ''}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select required name="plantilla" id="plantilla" class="form-control">
        ...
        <?php $edit=1;?>
        @include('uia.viewsgenerales.inspecciones.preguntasshow')
            ...
            <div class="col-md-12">
                <div class="card">                    
                    <div class="card-body">
                        ...
                        @include('uia.encuestas.modals.modalpregunta')
