...
function ValidarCita(id,_this){
    ...
    console.log($('#draw-dataUrl').val().length);
        ...
        html+='<div class="col-md-2">';
            html+='<div class="form-group">';
                ...
                html+='<div class="input-group">';
                    html+='<input required type="number" min=".01" step=".01" name="cantidad[],cantidadm" class="form-control" id="cantidad'+rowsmateriales+'" placeholder="Volumen" aria-invalid="true" onchange="CalcularCostoPorMaterialObra('+rowsmateriales+');">';
                    ...
                    html+='<div class="card-body">';
                        html+='<div class="row">';
                            html+='<div class="col-md-12">';
                                html+='<center><img id="portada'+contadorcatalogo+'" src="' +(catalogo[i].portada==null ? 'https://cdn.pixabay.com/photo/2017/01/25/17/35/picture-2008484_960_720.png' : catalogo[i].portada)+'" style="max-height:150px; border-radius:5px;" alt=""></center>';
                            html+='</div>';
                        html+='</div>';
                        html+='<div class="row">';
                            html+='<div class="col-md-12">';
...
function AgregarCarrito(_this,producto){
    ...
    if($('#cantidad'+_this.data('orden')).val()!=0){ 
        if(confirm('¿Quiere agregar '+$('#cantidad'+_this.data('orden')).val() +(producto == 1 ? ' m\xB3 '+' de ' : ' ')+_this.data('producto')+'?')){
            if(producto){
                var data = {id_producto:_this.data('id'),id_usuario:id_usuario,cantidad:$('#cantidad'+_this.data('orden')).val(),transporte:0};
            }else{
                var data = {id_transporte:_this.data('id'),id_usuario:id_usuario,cantidad:$('#cantidad'+_this.data('orden')).val(),transporte:0};
            }
